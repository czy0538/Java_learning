...
public class Test1 extends Frame implements ActionListener, WindowListener
{
    ...
    public Test1()       //构造方法设置布局、为按钮注册事件监听器
    {
        super("My Calculator");
    ...
    {
        myCalculator.Test1 calculator = new myCalculator.Test1();
    }
}
